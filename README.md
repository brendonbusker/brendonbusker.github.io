...
- Blog **Insert image** supports JPEG, PNG, WebP, AVIF, and animated GIFs. GIFs keep their original animation and resolution, with a 6 MB upload limit; use a smaller GIF if it exceeds that limit. They animate in the editor, preview, and public post. Other image formats continue through the existing WebP optimization. Uploaded images become publicly available after their GitHub Pages deployment completes.
